 ...
 * Copyright (c) 2009-2011 by geopost, Inc. All Rights Reserved.
...
//@interface geopostObject : NSObject
//@end

@interface geopostObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[geopostObject class]])
		{
			for (NSString *key in [[(geopostObject*)o modules] allKeys])
			{
