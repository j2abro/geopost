...
// in simulator we redefine to format for geopost Developer console
...
{\
	NSString * exceptionName = [@"org.geopost." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.geopost";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIgeopostNativeItemNone = -1, 
	UIgeopostNativeItemSpinner = -2,
	UIgeopostNativeItemProgressBar = -3,
	
	UIgeopostNativeItemSlider = -4,
	UIgeopostNativeItemSwitch = -5,
	UIgeopostNativeItemMultiButton = -6,
	UIgeopostNativeItemSegmented = -7,
	
	UIgeopostNativeItemTextView = -8,
	UIgeopostNativeItemTextField = -9,
	UIgeopostNativeItemSearchBar = -10,
	
	UIgeopostNativeItemPicker = -11,
	UIgeopostNativeItemDatePicker = -12,
	
	UIgeopostNativeItemInfoLight = -13,
	UIgeopostNativeItemInfoDark = -14,
	
	UIgeopostNativeItemDisclosure = -15,
	
	UIgeopostNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all geopost instances of
